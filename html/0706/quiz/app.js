...
var questions = [
  ...
  new Question('CSS 속성 중 글자의 굵기를 변경하는 속성은?',['font-size','font-style','font-weight','font-var'],'font-weight')
]
//퀴즈 객체 생성
...
function progress() {
  ...
  progress.innerHTML = '문제' + (quis.questionIndex + 1) + '/' + quiz.questions.length;
}
//결과 표시
function result() {
  var quiz_div = document.getElementById('quiz');//퀴즈 박스컨데이너
//백분률 점수 계산
...
function checkAnswer(i){
  brn[i].addEventListener('click', function(){//선택버튼 이벤트 리스너
